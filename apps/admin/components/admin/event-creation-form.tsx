...
import { FileUpload } from "@coderina-ams/ui/components/file-upload";
      ...
      <FieldGroup className="grid md:grid-cols-6 gap-4 mb-6">
          ...
          render={({ field, fieldState }) => (
            <div className="col-span-full">
              <Field
                ...
                className="gap-1 col-span-full lg:w-full md:w-full"
              >
                <FieldLabel htmlFor="fileupload">Media upload *</FieldLabel>
                <FieldDescription>
        ...
        <Controller
          ...
          render={({ field, fieldState }) => (
            <Field
              data-invalid={fieldState.invalid}
              className="gap-1 [&_p]:pb-2 w-full col-span-full"
            >
